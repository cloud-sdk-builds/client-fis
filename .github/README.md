...
[`@aws-sdk/client-fis`](https://www.npmjs.com/package/@aws-sdk/client-fis/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FLtV+Vw509G1+qNtmS/w47YmZDyPpqJyH0ol0OnvSVkSJjexScLCU+WYRbjWMCfg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-fis": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.572.0/index.min.mjs": "sha384-FLtV+Vw509G1+qNtmS/w47YmZDyPpqJyH0ol0OnvSVkSJjexScLCU+WYRbjWMCfg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-fis/blob/refs/tags/3.572.0/LICENSE
```
