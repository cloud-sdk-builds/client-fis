...
[`@aws-sdk/client-fis`](https://www.npmjs.com/package/@aws-sdk/client-fis/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tY1UeaazbSS05usJZVeJbGiPoKp7xJyGs69ZooF7QFmZR7hTGe2DP254JS7Ukiqm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-fis": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.241.0/index.min.mjs": "sha384-tY1UeaazbSS05usJZVeJbGiPoKp7xJyGs69ZooF7QFmZR7hTGe2DP254JS7Ukiqm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-fis/blob/refs/tags/3.241.0/LICENSE
```
