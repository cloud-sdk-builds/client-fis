...
[`@aws-sdk/client-fis`](https://www.npmjs.com/package/@aws-sdk/client-fis/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x8m2Sc8WQU3TSadznnLwr3jqND2q0Q6W22j7hyHDedjUCcZblfyfasm87Pav8/tt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-fis": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fis@3.32.0/index.min.mjs": "sha384-x8m2Sc8WQU3TSadznnLwr3jqND2q0Q6W22j7hyHDedjUCcZblfyfasm87Pav8/tt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-fis/blob/refs/tags/3.32.0/LICENSE
```
